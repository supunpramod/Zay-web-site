...
import { FaCog, FaBars, FaUserPlus, FaFileAlt, FaUpload, FaAddressBook } from 'react-icons/fa';

const Sidebar = ({ sidebarOpen, toggleSidebar, user, quickActions }) => {
  // Safe fallback for quickActions
  const actions = quickActions || [];

  return (
    <div
      className={`bg-gradient-to-b from-indigo-800 to-indigo-900 text-white h-screen fixed lg:static transform transition-transform duration-300 ${
